// src\components\admin\kegiatan\KegiatanCreate.tsx
"use client";
...
export default function CreateKegiatanPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) throw new Error(json.message || "Gagal menyimpan kegiatan");
  ...
  return (
    <>
      <Breadcrumb pageName="Kegiatan" mapName="Create Kegiatan" />
